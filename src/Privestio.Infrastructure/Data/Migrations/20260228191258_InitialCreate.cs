...
namespace Privestio.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityUserId = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningDate = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ...
                    CurrentBalanceAmount = table.Column<decimal>(
                        type: "numeric(18,4)",
                        nullable: false
                    ),
                    CurrentBalanceCurrency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
                    OpeningBalanceAmount = table.Column<decimal>(
                        type: "numeric(18,4)",
                        nullable: false
                    ),
                    OpeningBalanceCurrency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportDate = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedValueAmount = table.Column<decimal>(
                        type: "numeric(18,4)",
                        nullable: false
                    ),
                    EstimatedValueCurrency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportFingerprint = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_TransactionSplitTags",
                        x => new { x.TransactionSplitId, x.TagId }
                    );
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "TransactionSplitTags");

            migrationBuilder.DropTable(name: "TransactionTags");

            migrationBuilder.DropTable(name: "Valuations");

            migrationBuilder.DropTable(name: "AspNetRoles");

            migrationBuilder.DropTable(name: "AspNetUsers");

            migrationBuilder.DropTable(name: "TransactionSplits");
            ...
            migrationBuilder.DropTable(name: "Payees");
