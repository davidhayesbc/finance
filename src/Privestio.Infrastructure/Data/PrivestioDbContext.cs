...
public class PrivestioDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public DbSet<SecurityIdentifier> SecurityIdentifiers => Set<SecurityIdentifier>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HouseholdMember>().HasQueryFilter(e => !e.IsDeleted);
        modelBuilder.Entity<HouseholdInvitation>().HasQueryFilter(e => !e.IsDeleted);
        ...
        modelBuilder.Entity<SecurityIdentifier>().HasQueryFilter(e => !e.IsDeleted);
